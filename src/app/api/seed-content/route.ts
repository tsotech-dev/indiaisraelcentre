...
export async function GET() {
      ...
      routes: [
        {
          ...
          description:
            "For commissioning, submissions and editorial correspondence.",
        },
        { title: "Media inquiries", description: "For journalists." },
        {
          title: "Partner with us",
          description: "For institutional partnership inquiries.",
        },
      ],
    } as any,
  });
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      paragraph3:
        "Please write with a short introduction to your institution and the collaboration you have in mind.",
    } as any,
  });
  ...
  await payload.updateGlobal({
    ...
    data: {
      description:
        "Policy and issue briefs, written for working professionals.",
    } as any,
  });
  ...
  const PILLAR_SEEDS = [
    {
      ...
      shortFraming:
        "Nation-building, identity and continuity in two post-colonial states.",
      framing:
    ...
    },
    {
      ...
      shortFraming:
        "Constitutional design, democratic institutions and the politics of governance.",
      framing:
    ...
    },
    {
      ...
      shortFraming:
        "The India-Israel technology corridor and the geopolitics of innovation.",
      framing:
    ...
    },
    {
      ...
      shortFraming:
        "Water, agriculture, energy and the practical record of development cooperation.",
      framing:
  ...
  const commentaries = [
    ...
    {
      title:
        "Bene Israel, Cochin and Baghdadi: The Three Continuous Histories of Jewish India",
